<div class="container" style='padding-top: 6vh;'>
    <h1 class="text-center" style='padding-bottom: 6vh;'>Les logements :</h1>
            ...
            <a href="/logement/type2" style="text-decoration:none; color: black;">
                <div class="card card-height">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Entrée, 2 chambres à 2 lits avec coin toilette (douche, wc) et balcon.</p>
                        <p>Nombre de logement disponible : <?= $nbr_logement_type2 ?></p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="/logement/type3" style="text-decoration:none; color: black;">
                <div class="card card-height">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Entrée, 2 chambres à 2 lits avec coin toilette (douche, wc) et balcon.</p>
                        <p>Nombre de logement disponible : <?= $nbr_logement_type3?></p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="/logement/type4" style="text-decoration:none; color: black;">
                <div class="card card-height">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Entrée, 2 chambres à 2 lits avec coin toilette (douche, wc) et balcon.</p>
                        <p>Nombre de logement disponible : <?= $nbr_logement_type4 ?></p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="/logement/type5" style="text-decoration:none; color: black;">
                <div class="card card-height">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"></p>
                        <p>Nombre de logement disponible : <?= $nbr_logement_type5 ?></p>
                    </div>
                </div>
            </a>
        </div>
